...
import { CrispyFormField, CrispyMatFormComponent, crispyCustomComponentField, crispyDateRangeField, crispyFormFieldGroup, crispyPasswordField, crispySelectField, crispyTemplateField, crispyTextField } from 'dist/crispy-mat-form';
import { of } from 'rxjs';
  ...
  <div class="m-2">
    ...
    <form [formGroup]="crispyComponent.form" (ngSubmit)="onSubmit()">
      ...
      <div>
        ...
        >Reset</button
        >&nbsp;
        <button mat-raised-button color="primary" type="submit" [disabled]="crispyComponent.form.invalid">Submit</button>
      </div>
    </form>
  </div>
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const matchPasswords = (fg: FormGroup<any>): ValidationErrors|null => {
      let password = undefined; let confirmPassword = undefined;
    ...
    this.cffs = [
      ...
      crispyFormFieldGroup('matchingPassword', [
        crispyPasswordField(
          'password',
          '',
      ...
      ], undefined, (fg) => matchPasswords(fg as FormGroup)),
      crispySelectField(
        'sex',
        [
          { label: 'Male', value: 'M' },
      ...
      crispyTemplateField(
        'mobile', 
        { area: '737', exchange: '777', subscriber: '0787' },
      )
    ];
  }
  ...
  onSubmit() {
    console.log(
      `onSubmit - form.value: ${JSON.stringify(this.crispyComponent.form.value)}`
    );
  }
}
